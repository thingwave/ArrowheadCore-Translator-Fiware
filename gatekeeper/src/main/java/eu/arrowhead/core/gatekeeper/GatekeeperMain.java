...
import eu.arrowhead.common.database.*;
...
public class GatekeeperMain implements NeedsCoreSystemService {
    ...
    public static final String GATEKEEPER_SERVICE_URI = "gatekeeper";
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            final String[] serverCN = getServerCN(gatekeeperKeystorePath, gatekeeperKeystorePass, false)
                    .split("\\.");
            final ArrowheadCloud cloud = new ArrowheadCloud(
                    serverCN[2],
                    serverCN[3] + (IS_SECURE ? "" : "-insecure"),
                    address,
                    IS_SECURE ? externalSecurePort : externalInsecurePort,
                    GATEKEEPER_SERVICE_URI,
                    IS_SECURE ? getAuthBase64(gatekeeperKeystorePath, gatekeeperKeystorePass) : null,
                    IS_SECURE
            );
