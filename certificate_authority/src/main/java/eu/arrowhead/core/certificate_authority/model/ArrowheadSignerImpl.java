...
import io.github.olivierlemasle.ca.Signer;
...
public class ArrowheadSignerImpl implements Signer, SignerWithSerial {
  ...
  public ArrowheadSignerImpl(final KeyPair signerKeyPair, final DistinguishedName signerDn, final PublicKey publicKey, final DistinguishedName dn) {
  ...
  @Override
  public SignerWithSerial addExtension(final ASN1ObjectIdentifier oid, final boolean isCritical, final ASN1Encodable value) {
  ...
  public Certificate sign() {
    try {
      ...
      return new ArrowheadCertificateImpl(cert);
