...
--
-- Table structure for table `arrowhead_device`
--

DROP TABLE IF EXISTS `arrowhead_device`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `arrowhead_device` (
  `id` bigint(20) NOT NULL,
...
CREATE TABLE `device_registry` (
  ...
  `arrowhead_device_id` bigint(20) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UKpumbuvwgjraw807wtgvp6w7oh` (`arrowhead_device_id`),
  CONSTRAINT `FK4b935fnyktxik03txy3fkom7q` FOREIGN KEY (`arrowhead_device_id`) REFERENCES `arrowhead_device` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `system_registry` (
  ...
  `end_of_validity` datetime(6) DEFAULT NULL,
  `service_uri` varchar(255) DEFAULT NULL,
  `arrowhead_system_id` bigint(20) NOT NULL,
  `provider_device_id` bigint(20) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UKkqc7tn5texdlpbw5of8if9oix` (`arrowhead_system_id`,`provider_device_id`),
  KEY `FKj56bprjvaw38hwixi31b4m95t` (`provider_device_id`),
  CONSTRAINT `FK7mj5h0lug49n3iq6vkess9i7e` FOREIGN KEY (`arrowhead_system_id`) REFERENCES `arrowhead_system` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FKj56bprjvaw38hwixi31b4m95t` FOREIGN KEY (`provider_device_id`) REFERENCES `arrowhead_device` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-11-20 13:39:57
