...
# TODO arrowheadsystem ports are hardcoded right now, which is a problem if they will not match the actually sent in values
...
INSERT INTO arrowhead_system VALUES (1, 'localhost', '${consumer64pub}', 8080, 'client1');
INSERT INTO arrowhead_system VALUES (2, 'localhost', '${provider64pub}', 8461, 'SecureTemperatureSensor');
INSERT INTO arrowhead_service VALUES (1, 'IndoorTemperature');
INSERT INTO arrowhead_service_interfaces VALUES (1,'JSON');
