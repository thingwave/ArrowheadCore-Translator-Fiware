...
public class SystemRegistryMain extends ArrowheadMain {
	private SystemRegistryMain(String[] args) {
		...
		String[] packages = {"eu.arrowhead.common.exception", "eu.arrowhead.common.json", "eu.arrowhead.common.filter", "eu.arrowhead.systemregistry", "eu.arrowhead.systemregistry.model", "eu.arrowhead.systemregistry.filter" };
